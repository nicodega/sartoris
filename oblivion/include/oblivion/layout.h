...
#define FSM_THR 10             /* filesystem thread */
#define RAMFS_THR 11           /* ram-filesystem thread */
#define DMA_MAN_THR 12         /* dma-manager thread */
#define HDC_THR	20             /* hard-drive thread */
#define IDE0_IRQ_SERV_THR 21   /* IDE0 int handler */
#define IDE1_IRQ_SERV_THR 22   /* IDE1 int handler */
