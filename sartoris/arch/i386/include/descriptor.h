...
#define DESC_32_BIG   0x00c08000                 // P=1, G=1, D=1 (32bit)
#define DESC_32_SMALL 0x00408000                 // P=1, G=0, D=1 (32bit)

#define SEGMENT_32   0x400000                    //(0x1 << 22) defines a segment default operation size as 32bit 
...
#define G_DW1_OFFSET(x) ((unsigned int)x & 0xffff0000)
