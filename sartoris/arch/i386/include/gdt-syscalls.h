...
%define OPEN_PORT                (0x19 << 3)
%define CLOSE_PORT               (0x1a << 3)
%define SET_PORT_PERM            (0x1b << 3)
%define SET_PORT_MODE            (0x1c << 3)    
%define SEND_MSG                 (0x1d << 3)
%define GET_MSG                  (0x1e << 3)
%define GET_MSG_COUNT            (0x1f << 3)
    
%define SHARE_MEM                (0x20 << 3)
%define CLAIM_MEM                (0x21 << 3)
%define READ_MEM                 (0x22 << 3)
%define WRITE_MEM                (0x23 << 3)
%define PASS_MEM                 (0x24 << 3)
%define MEM_SIZE                 (0x25 << 3)
