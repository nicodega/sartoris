...
CHANGE THIS TO CREATE A SMALL STUB FOR THE THREAD AND LET IT DO A COMMON RET: Called thread must issue ret_from_int to return.
This can be useful to implement unix-like signals on host OSs.
*/
